...
const AdminProducts = () => {
  ...
  const addProduct = () => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/v1/product/addProduct', {
          withCredentials: true
        });
  ...
  const updateProduct = () => {
    const fetchProducts = async () => {
      try {
        const response = await axios.get('http://localhost:3000/api/v1/product/editProduct', {
          withCredentials: true
        });
    ...
    const deleteProduct = () => {
      const fetchProducts = async () => {
        try {
          const response = await axios.get('http://localhost:3000/api/v1/product/deleteProduct', {
            withCredentials: true
          });
